...
namespace LibGDXSharp.Utils
{
    ...
    public abstract class ByteBuffer : Buffer, IComparable< ByteBuffer >
    {
        ...
        internal ByteBuffer( int mark, int pos, int lim, int cap, sbyte[] hb, int offset )
        ...
        /// initialized to zero.  It will have a <see cref="array backing array"/>,
        ...
        /// its <see cref="arrayOffset array offset"/> will be zero.  </para>
        /// </summary>
        /// <param name="array">
        ...
        /// given array, and its <see cref="arrayOffset array offset>"/> will
        /// be zero.  </para>
        /// </summary>
        /// <param name="array">
        ...
        /// exactly the same way as the <see cref="duplicate duplicate"/> method.  </para>
        /// </summary>
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
        ...
        /// <see cref="Byte.compare(sbyte,sbyte)"/>.
        /// 
        /// 
        /// </para>
