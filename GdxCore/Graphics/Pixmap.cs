...
namespace LibGDXSharp.Graphics
{
    ...
    public class Pixmap : IDisposable
    {
        ...
        /// </summary>
        public Blending BlendValue
        {
            get => _blend;
            set
            {
                this._blend = value;
                gdx2DPixmap.SetBlend( _blend == Blending.None ? 0 : 1 );
            }
        }
        ...
        public virtual void DrawPixel( int x, int y, int color )
        {
        ...
        public ByteBuffer Pixels
        {
            get
            {
                ...
                return gdx2DPixmap.Pixels;
            }
            set
            {
                ByteBuffer dst = gdx2DPixmap.Pixels;
                BufferUtils.Copy( value, dst, dst.Limit() );
            }
        }

        /// <returns> the <see cref="Pixmap.Format"/> of this Pixmap. </returns>
        public Format PixFormat => PixmapFormat.FromGdx2DPixmapFormat( gdx2DPixmap.PixFormat );
