...
//                SetLoader( typeof(Cubemap),         new CubemapLoader( resolver ) );
        ...
        public void Unload( string fileName )
        {
            ...
            if ( _tasks.Count > 0 )
            {
                ...
                if ( currentTask.AssetDesc.FilePath.Equals( fileName ) )
                {
...
//                if ( assetsByType != null )
        ...
        {
            if ( _loaders.TryGetValue( type, out AssetLoader? loader ) )
            {
                return loader;
            }
        ...
        private void InjectDependency( string parentAssetFilename, AssetDescriptor dependendAssetDesc )
        {
            ...
            dependencies.Add( dependendAssetDesc.FilePath );
