...
namespace LibGDXSharp.Assets.Loaders
{
    ...
    public abstract class AsynchronousAssetLoader : AssetLoader
    {
        ...
        public abstract void LoadAsync( AssetManager? manager, string? fileName, FileInfo? file, IAssetLoaderParameters parameter );
        public abstract object LoadSync( AssetManager? manager, string? fileName, FileInfo? file, IAssetLoaderParameters parameter );

        public void UnloadAsync( AssetManager? manager, string? fileName, FileInfo? file, IAssetLoaderParameters parameter )
        {
        }
    }
    ...
    public abstract class AsynchronousAssetLoader<T, TP> : AssetLoader where TP : AssetLoaderParameters
    {
        ...
        /// <param name="parameter"></param>
        /// <returns></returns>
        public abstract T LoadSync( AssetManager? manager, string? fileName, FileInfo? file, IAssetLoaderParameters parameter );
