...
public class TooltipManager<T> where T : Actor
{
    ...
    public TooltipManager()
    {
        ...
        this._showTaskCancellationTokenSource = new CancellationTokenSource();
        this._showTaskCancellationToken       = _showTaskCancellationTokenSource.Token;
...
//            Timer.schedule( showTask, time );
    ...
    protected void ShowAction( Tooltip< T > tooltip )
    {
        ...
        tooltip.Container.AddAction( SceneActions.Parallel( SceneActions.FadeIn( actionTime, Interpolation.fade ),
                                                            SceneActions.ScaleTo( 1, 1, actionTime, Interpolation.fade ) ) );
    }
    ...
    protected static void HideAction( Tooltip< T > tooltip )
    {
        tooltip.Container.AddAction( SceneActions.Sequence(
                                         SceneActions.Parallel( SceneActions.Alpha( 0.2f, 0.2f, Interpolation.fade ),
                                                                SceneActions.ScaleTo( 0.05f, 0.05f, 0.2f, Interpolation.fade ) ),
