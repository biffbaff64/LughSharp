...
----
    ...
    -      - IVector
    -      - MathUtils
    -      - Matrix3                Convert, C# has no Matrix3x3 only Matrix3x2
    -      - Matrix4                use System.Numerics.Matrix4x4
    -      - Plane
    -      - Polygon
    -      - Polyline
    -      - Quaternion
    -      - RandomXS128
    -      - RectangleShape
    -      - Vector2                use System.Numerics.Vector2
    -      - Vector3                use System.Numerics.Vector3
    -      - WindowedMean
...
-----------------
    ...
    Maps
    ----
    - DONE - ArrayMap                       Replace with Dictionary<K, V>
