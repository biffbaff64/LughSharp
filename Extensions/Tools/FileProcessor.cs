...
using File = LibGDXSharp.Files.File;
...
public class FileProcessor
{
    ...
    private IComparer< File > comparator = new IComparer< File >()
    {
...
public FileProcessor addInputSuffix( String
...
public FileProcessor addInputRegex( String
...
public ArrayList< Entry > process( String inputFileOrDir, String outputRoot )
...
public ArrayList< Entry > process( File inputFileOrDir, File outputRoot )
