...
public class BoundingBox
{
    ...
    public bool Intersects( BoundingBox b )
    {
        ...
        var lx   = Math.Abs( this._cnt.X - b._cnt.X );
        var sumx = ( this._dim.X / 2.0f ) + ( b._dim.X / 2.0f );

        var ly   = Math.Abs( this._cnt.Y - b._cnt.Y );
        var sumy = ( this._dim.Y / 2.0f ) + ( b._dim.Y / 2.0f );
    ...
    /// <summary>
    /// Returns whether the given vector is contained in this bounding box. </summary>
