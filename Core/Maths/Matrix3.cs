...
public class Matrix3
{
    ...
    /// Remember that this matrix is in <a href="http://en.wikipedia.org/wiki/Row-major_order#Column-major_order">
    /// column major</a> order. (The float array is not modified.)
    /// </param>
