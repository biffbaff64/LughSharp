...
/// </summary>
public interface IInterpolationOld
{
    // ------------------------------------------------------------------------
...
public abstract class InterpolationOld : IInterpolationOld
{
    // ReSharper disable once MemberCanBeProtected.Global
    public abstract float Apply( float a );

    public class Linear : InterpolationOld
    {
    ...
    public class Smooth : InterpolationOld
    {
        public override float Apply( float a ) => a * a * ( 3 - ( 2 * a ) );
    }

    public class Smooth2 : InterpolationOld
    {
        public override float Apply( float a )
        {
            a = a * a * ( 3 - ( 2 * a ) );
    ...
    public class Smoother : InterpolationOld
    {
        public override float Apply( float a )
        {
    ...
    public class Pow2InInverse : InterpolationOld
    {
        public override float Apply( float a )
        {
    ...
    public class Pow2OutInverse : InterpolationOld
    {
        public override float Apply( float a )
        {
            if ( a < MathUtils.FLOAT_ROUNDING_ERROR ) return 0;
    ...
    public class Pow3InInverse : InterpolationOld
    {
        public override float Apply( float a ) => (float)Math.Cbrt( a );
    }

    public class Pow3OutInverse : InterpolationOld
    {
        public override float Apply( float a ) => (float)Math.Cbrt( -( a - 1 ) );
    }
    
    public class Sine : InterpolationOld
    {
        public override float Apply( float a )
        {
...
//    public readonly Interpolation_OLD sineIn = new Interpolation_OLD()
//    {
//        public float apply( float a )
//        {
...
//    public readonly Interpolation_OLD sineOut = new Interpolation_OLD()
//    {
//        public float apply( float a )
//        {
...
//    public readonly Interpolation_OLD circle = new Interpolation_OLD()
//    {
//        public float apply( float a )
//        {
//            if ( a <= 0.5f )
...
//    public readonly Interpolation_OLD circleIn = new Interpolation_OLD()
//    {
//        public float apply( float a )
//        {
...
//    public readonly Interpolation_OLD circleOut = new Interpolation_OLD()
//    {
//        public float apply( float a )
//        {
//            a--;
...
/*
    ...
    public class Linear : Interpolation_OLD
    {
    ...
    public class Pow : Interpolation_OLD
    {
    ...
    public class Exp : Interpolation_OLD
    {
    ...
    public class Elastic : Interpolation_OLD
    {
        protected readonly float value;
        protected readonly float power;
        protected readonly float scale;
    ...
    public class BounceOut : Interpolation_OLD
    {
    ...
    public class Swing : Interpolation_OLD
    {
    ...
    public class SwingOut : Interpolation_OLD
    {
        private readonly float _scale;
    ...
    public class SwingIn : Interpolation_OLD
    {
        private readonly float _scale;
