...
namespace LibGDXSharp.Graphics.OpenGL;
...
public static partial class GL
{
    ...
    public static void glTexImage2D( int target,
                                     ...
                                     int format,
                                     int type, /*const*/
                                     void* pixels ) => _glTexImage2D( target, level, internalFormat, width, height, border, format, type, pixels );
    ...
    public static void glTexImage3D( int target,
                                     ...
                                     int format,
                                     int type,
                                     IntPtr pixels ) => _glTexImage3D( target,
                                                                       level,
                                                                       internalFormat,
                                                                       width,
                                                                       height,
    ...
    public static void glTexImage3D( int target,
                                     ...
                                     int format,
                                     int type, /*const*/
                                     void* pixels ) => _glTexImage3D( target, level, internalFormat, width, height, depth, border, format, type, pixels );
    ...
    public static void glTexSubImage3D( int target,
                                        ...
                                        int format,
                                        int type,
                                        IntPtr pixels ) => _glTexSubImage3D( target,
                                                                             level,
                                                                             xOffset,
                                                                             yOffset,
                                                                             zOffset,
    ...
    public static void glTexSubImage3D( int target,
                                        ...
                                        int format,
                                        int type, /*const*/
                                        void* pixels ) => _glTexSubImage3D( target,
                                                                            level,
                                                                            xOffset,
                                                                            yOffset,
                                                                            zOffset,
    ...
    public static void glCompressedTexImage3D( int target,
                                               ...
                                               int border,
                                               int imageSize,
                                               IntPtr data ) => _glCompressedTexImage3D( target,
                                                                                         level,
                                                                                         internalFormat,
                                                                                         width,
                                                                                         height,
    ...
    public static void glCompressedTexImage3D( int target,
                                               ...
                                               int border,
                                               int imageSize, /*const*/
                                               void* data ) => _glCompressedTexImage3D( target,
                                                                                        level,
                                                                                        internalFormat,
                                                                                        width,
                                                                                        height,
    ...
    public static void glCompressedTexImage2D( int target,
                                               ...
                                               int border,
                                               int imageSize, /*const*/
                                               void* data ) => _glCompressedTexImage2D( target, level, internalFormat, width, height, border, imageSize, data );
    ...
    public static void glCompressedTexSubImage3D( int target,
                                                  ...
                                                  int format,
                                                  int imageSize,
                                                  IntPtr data ) => _glCompressedTexSubImage3D( target,
                                                                                               level,
                                                                                               xOffset,
                                                                                               yOffset,
                                                                                               zOffset,
    ...
    public static void glCompressedTexSubImage2D( int target,
                                                  ...
                                                  int format,
                                                  int imageSize,
                                                  IntPtr data ) => _glCompressedTexSubImage2D( target,
                                                                                               level,
                                                                                               xOffset,
                                                                                               yOffset,
                                                                                               width,
    ...
    public static void glCompressedTexSubImage3D( int target,
                                                  ...
                                                  int format,
                                                  int imageSize, /*const*/
                                                  void* data ) => _glCompressedTexSubImage3D( target,
                                                                                              level,
                                                                                              xOffset,
                                                                                              yOffset,
                                                                                              zOffset,
    ...
    public static void glCompressedTexSubImage2D( int target,
                                                  ...
                                                  int format,
                                                  int imageSize, /*const*/
                                                  void* data ) => _glCompressedTexSubImage2D( target,
                                                                                              level,
                                                                                              xOffset,
                                                                                              yOffset,
                                                                                              width,
    ...
    public static IntPtr glMapBufferRange( int target, int offset, int length, uint access )
        => new IntPtr( _glMapBufferRange( target, new IntPtr( offset ), new IntPtr( length ), access ) );
    ...
    public static void glGetActiveAttrib( uint program,
                                          uint index,
                                          int bufSize,
                                          out int length,
                                          out int size,
    ...
    public static void glGetActiveUniform( uint program,
                                           uint index,
                                           int bufSize,
                                           out int length,
                                           out int size,
    ...
    public static void glMultiDrawElementsBaseVertex( int mode, /*const*/
                                                      int* count,
                                                      int type, /*const*/
                                                      void* /*const*/* indices,
                                                      int drawCount, /*const*/
                                                      int* baseVertex ) => _glMultiDrawElementsBaseVertex( mode, count, type, indices, drawCount, baseVertex );
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLTEXIMAGE2DPROC( int target,
                                               int level,
                                               int internalformat,
                                               int width,
                                               int height,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLTEXSUBIMAGE2DPROC( int target,
                                                  int level,
                                                  int xoffset,
                                                  int yoffset,
                                                  int width,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLTEXIMAGE3DPROC( int target,
                                               int level,
                                               int internalformat,
                                               int width,
                                               int height,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLTEXSUBIMAGE3DPROC( int target,
                                                  int level,
                                                  int xoffset,
                                                  int yoffset,
                                                  int zoffset,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLCOMPRESSEDTEXIMAGE3DPROC( int target,
                                                         int level,
                                                         int internalformat,
                                                         int width,
                                                         int height,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLCOMPRESSEDTEXIMAGE2DPROC( int target,
                                                         int level,
                                                         int internalformat,
                                                         int width,
                                                         int height,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLCOMPRESSEDTEXIMAGE1DPROC( int target,
                                                         int level,
                                                         int internalformat,
                                                         int width,
                                                         int border,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC( int target,
                                                            int level,
                                                            int xoffset,
                                                            int yoffset,
                                                            int zoffset,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC( int target,
                                                            int level,
                                                            int xoffset,
                                                            int yoffset,
                                                            int width,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLGETTRANSFORMFEEDBACKVARYINGPROC( uint program,
                                                                uint index,
                                                                int bufSize,
                                                                out int length,
                                                                out int size,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLBLITFRAMEBUFFERPROC( int srcX0,
                                                    int srcY0,
                                                    int srcX1,
                                                    int srcY1,
                                                    int dstX0,
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC( int mode, /*const*/
                                                                int* count,
                                                                int type, /*const*/
                                                                void* /*const*/* indices,
                                                                int drawCount, /*const*/
    ...
    [UnmanagedFunctionPointer( CallingConvention.Cdecl )]
    private delegate void PFNGLTEXIMAGE3DMULTISAMPLEPROC( int target,
                                                          int samples,
                                                          int internalformat,
                                                          int width,
                                                          int height,
