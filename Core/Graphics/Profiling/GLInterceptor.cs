...
public abstract class GLInterceptor : IGL20
{
    ...
    public abstract void      GLDeleteTextures( int n, int textures );
    ...
    public abstract void      GLDrawElements( PrimitiveType mode, int count, DrawElementsType type, Buffer indices );
    public abstract void      GLEnable( EnableCap cap );
    public abstract void      GLFinish();
    public abstract void      GLFlush();
    public abstract void      GLFrontFace( FrontFaceDirection mode );
    public abstract void      GLGenTextures( int n, int[] textures );
    ...
    public abstract void   GLDrawElements( PrimitiveType mode, int count, DrawElementsType type, int indices );
    ...
    public abstract void GLVertexAttribPointer( int indx, int size, VertexAttribType type, bool normalized, int stride, Buffer ptr );

    public abstract void GLVertexAttribPointer( int indx, int size, VertexAttribType type, bool normalized, int stride, int ptr );
}
