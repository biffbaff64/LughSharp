...
public abstract class GLInterceptor : IGL20
{
    ...
    public abstract void GLCopyTexSubImage2D( TextureTarget target, int level, int xoffset, int yoffset, int x, int y, int width, int height );
    public abstract void GLCullFace( CullFaceMode mode );
    public abstract void GLDeleteTextures( int n, uint textures );
    public abstract void GLDeleteTexture( uint texture );
    public abstract void GLDepthFunc( DepthFunction func );
    public abstract void GLDepthMask( bool flag );
    public abstract void GLDepthRangef( float zNear, float zFar );
    public abstract void GLDisable( EnableCap cap );
    public abstract void GLDrawArrays( PrimitiveType mode, int first, int count );
    public abstract void GLDrawElements( int mode, int count, int type, Buffer indices );
    public abstract void GLEnable( EnableCap cap );
    public abstract void GLFinish();
    public abstract void GLFlush();
    public abstract void GLFrontFace( FrontFaceDirection mode );
    public abstract void GLGenTextures( int n, uint[] textures );
    ...
    public abstract void GLDeleteBuffer( uint buffer );
    public abstract void GLDeleteBuffers( int n, uint buffers );
    ...
    public abstract void GLDeleteShader( uint shader );
    public abstract void GLDetachShader( uint program, uint shader );
    ...
    public abstract void GLGenBuffers( int n, uint[] buffers );
    ...
    public abstract void GLValidateProgram( uint program );
    public abstract void GLVertexAttrib1F( uint indx, float x );
    public abstract void GLVertexAttrib1Fv( uint indx, FloatBuffer values );
    public abstract void GLVertexAttrib2F( int indx, float x, float y );
    public abstract void GLVertexAttrib2Fv( uint indx, FloatBuffer values );
    public abstract void GLVertexAttrib3F( int indx, float x, float y, float z );
    public abstract void GLVertexAttrib3Fv( uint indx, FloatBuffer values );
