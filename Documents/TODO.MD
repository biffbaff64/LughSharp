...
----
    ...
    Do I need IInput, IInputAdapter, AbstractInput, and InputAdapter?
    Could they become just one interface and one class?
...
-----------------
    ...
    - IP   - SnapshotArray                  Insert the necessary bits from Array<> / remove dependency
